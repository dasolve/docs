...
- **Monorepo Requirement:** Requires a monorepo structure ([ADR-013](./ADR-013.md)) where frontend can import backend types directly.
...
- **Monorepo Structure:** Backend and frontend will be in the same monorepo ([ADR-013](./ADR-013.md)) to enable easy type imports.
